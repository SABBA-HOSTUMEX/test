...
namespace iiiStoryEditor.UI.ViewModels
{
    ...
    [Binding]
    public class StoryboardResViewModel : ViewModel
    {
        ...
        [SerializeField]
        private StoryFolderViewModel m_projectFolder = null;
        [Binding]
        public StoryFolderViewModel ProjectFolder
        {
        ...
        protected override void Start()
        {
            ...
            {
                m_projectFolder = GetComponentInChildren<StoryFolderViewModel>();
            }
        ...
        protected virtual async void OnProjectFolderOpen(ProjectItem projectItem)
        {
            ...
            else
            {
                if (m_project.Utils.IsScene(projectItem))
                {
                    ...
                    {
                        WindowManager.MessageBox("Unable to load scene" + " " + projectItem.ToString(), exc.Message);
                        Debug.LogError(exc);
                    }
                    finally
                    {
