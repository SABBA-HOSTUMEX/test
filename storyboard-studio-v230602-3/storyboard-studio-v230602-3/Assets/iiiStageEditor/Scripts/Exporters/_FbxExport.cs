...
{
    [ExecuteInEditMode]
    public class _FbxExport : MonoBehaviour
    {


        public string meta_Title = "FBX Export";
        public string meta_Subject = "FBX Subject";
        public string meta_Keywords = "FBX Keywords";
        public string meta_Comments = "FBX Comments";
        ...
        public int ExportObjects(IEnumerable<UnityEngine.Object> exportObects, string fbxFilePath)
        {
            ...
            using (var fbxManager = FbxManager.Create())
            {
                ...
                fbxSceneInfo.mTitle = meta_Title;
                fbxSceneInfo.mSubject = meta_Subject;
                fbxSceneInfo.mAuthor = "iii";
                fbxSceneInfo.mRevision = "1.0";
                fbxSceneInfo.mKeywords = meta_Keywords;
                fbxSceneInfo.mComment = meta_Comments;
                ...
                IEnumerable<UnityEngine.Object> unityExportSet = exportObects;
