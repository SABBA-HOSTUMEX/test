...
public struct FullBodyIKJob : IAnimationJob
{
    ...
    public EffectorHandle leftShoulderffector;
    public EffectorHandle rightShoulderEffector;
    public EffectorHandle leftToeffector;
    public EffectorHandle rightToeEffector;
