...
namespace Battlehub.RTEditor
{
	public class EditorsMapCreator : IEditorsMapCreator
	{
		...
		void IEditorsMapCreator.Create(IEditorsMap map)
		{
			...
			map.AddMapping(typeof(UnityEngine.Animation), 27, false, false);
			map.AddMapping(typeof(UnityEngine.AudioListener), 27, true, false);
			map.AddMapping(typeof(UnityEngine.AudioSource), 27, true, false);
			map.AddMapping(typeof(UnityEngine.BoxCollider), 28, false, false);
			map.AddMapping(typeof(UnityEngine.UI.Button), 27, true, false);
			map.AddMapping(typeof(UnityEngine.Camera), 29, true, false);
			map.AddMapping(typeof(UnityEngine.Canvas), 27, true, false);
			map.AddMapping(typeof(UnityEngine.CapsuleCollider), 28, false, false);
			...
			map.AddMapping(typeof(UnityEngine.MeshCollider), 27, false, false);
			map.AddMapping(typeof(UnityEngine.MeshFilter), 27, false, false);
			map.AddMapping(typeof(UnityEngine.MeshRenderer), 30, true, false);
			map.AddMapping(typeof(UnityEngine.MonoBehaviour), 27, false, false);
			map.AddMapping(typeof(UnityEngine.RectTransform), 31, true, false);
			map.AddMapping(typeof(UnityEngine.Rigidbody), 27, true, false);
			map.AddMapping(typeof(UnityEngine.SkinnedMeshRenderer), 27, false, false);
			map.AddMapping(typeof(UnityEngine.Skybox), 27, true, false);
			map.AddMapping(typeof(UnityEngine.SphereCollider), 28, false, false);
			...
			map.AddMapping(typeof(UnityEngine.Transform), 32, true, false);
			map.AddMapping(typeof(UnityEngine.UI.VerticalLayoutGroup), 27, true, false);
			map.AddMapping(typeof(RuntimeAnimation), 27, false, false);
			map.AddMapping(typeof(StoryCameraSwitch), 27, true, false);
			map.AddMapping(typeof(StoryCanAnimObject), 33, true, false);
			map.AddMapping(typeof(StoryCharacter), 34, false, false);
			map.AddMapping(typeof(StoryCharAnimObject), 34, true, false);
