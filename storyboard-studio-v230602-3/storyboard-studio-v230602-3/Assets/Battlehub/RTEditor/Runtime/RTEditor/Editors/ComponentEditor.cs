...
namespace Battlehub.RTEditor
{
    ...
    public class ComponentEditor : MonoBehaviour
    {
        ...
        //protected internal Transform EditorsPanel        //liwei edit
...
#pragma warning restore CS0612
        ...
        protected virtual void BuildEditor(IComponentDescriptor componentDescriptor, PropertyDescriptor[] descriptors)
        {
            ...
            for (int i = 0; i < descriptors.Length; ++i)
            {
                ...
                //BuildPropertyEditor(descriptor); //liwei edit

                //liwei edit {
                if (descriptor.MemberInfo.Name != "shadows"
                    && descriptor.MemberInfo.Name != "cookie"
                    && descriptor.MemberInfo.Name != "cookieSize"
                    && descriptor.MemberInfo.Name != "flare"
                    && descriptor.MemberInfo.Name != "renderMode"
                    && descriptor.MemberInfo.Name != "shadowResolution"
                    && descriptor.MemberInfo.Name != "shadowBias"
                    && descriptor.MemberInfo.Name != "shadowNormalBias"
                    && descriptor.MemberInfo.Name != "shadowNearPlane")
                {
