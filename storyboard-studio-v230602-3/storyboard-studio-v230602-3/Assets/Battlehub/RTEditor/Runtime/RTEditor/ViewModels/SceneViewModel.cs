...
namespace Battlehub.RTEditor.ViewModels
{
    ...
    public class SceneViewModel : ViewModel
    {
        ...
        public override async void OnExternalObjectEnter()
        {
            ...
            //Debug.Log("OnExternalObjectEnter");

            BGObject = GameObject.FindGameObjectWithTag("SceneBG");
            if(BGObject != null)
            {
        ...
        public override void OnExternalObjectLeave()
        {
            ...
            //Debug.Log("OnExternalObjectLeave");
        ...
        public void OnObjectDrag(GameObject m_Instance, HashSet<Transform> InstanceTransforms, Ray pointer, Vector3 point)
        {
            if (m_Instance != null)
            {
                ...
                RaycastHit hit = Physics.RaycastAll(pointer).Where(h => !InstanceTransforms.Contains(h.transform)).FirstOrDefault();
        ...
        public override void OnExternalObjectDrag()
        {
            base.OnExternalObjectDrag();
             ...
             Debug.Log("OnExternalObjectDrag");
            Vector3 point;
        ...
        public override void OnExternalObjectDrop()
        {
            ...
            Debug.Log("OnExternalObjectDrop");
            if (m_prefabInstance != null)
            {
                RecordUndo();
                m_prefabInstance = null;
        ...
        protected virtual ExposeToEditor ExposePrefabInstance(GameObject prefabInstance)
        {
            ...
            //Debug.Log("ExposePrefabInstance");
        ...
        {
            //Debug.Log("OnActivatePrefabInstance");
